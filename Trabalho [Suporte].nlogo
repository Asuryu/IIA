...
assassinos-own[tik]
globals[depositos num numc numl counter quant_res capacidade limite]
comiloes-own[tipo idade]
ovoComilao-own[tic]
turtles-own[energy fertilidade]
...
to Setup-patches
  ...
  [
    ...
    if random 101 < lixoToxico
    [
      set pcolor red
    ]
    if random 101 < nAlimento
    [
     set pcolor green
    ]
  ]
...
to setup-turtles
  create-comiloes numcomiloes
  create-limpadores numlimpadores
  create-Assassinos numAssassinos
  ...
  [
      ...
      [
        ...
        [
          ...
          [
            ifelse [pcolor] of patch-here = red ; LIXO TOXICO NA PATCH
            [
            ...
            [
              ifelse [pcolor] of patch-ahead 1 = red ; LIXO TOXICO FRENTE
              [
                fd 1
              ]
              [
                ...
                [
                  ...
                  [
                    ...
                    [
                    set energy energy + (quantEnergia / 2)
                  ]
                  ]
                  [
...
to regrow-patches
  ...
  if count patches with [pcolor = yellow] <= 30 and lixoNormal != 0
  [
    ask patches with [pcolor = black]
    [
      if random 101 < 1
  ...
  if count patches with [pcolor = red] <= 30 and lixoToxico != 0
  [
    ask patches with [pcolor = black]
    [
      if random 101 < 2
  ...
  if count patches with [pcolor = green] < 20 and nAlimento != 0
  [
    ask patches with [pcolor = black]
    [
      if random 101 < 2
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="numAssassinos">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="numlimpadores">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="energiainicial">
      <value value="500"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="nAlimento">
      <value value="17"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="nrDepositos">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="lixoNormal">
      <value value="11"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="numcomiloes">
      <value value="20"/>
    </enumeratedValueSet>
  ...
  <experiment name="ola" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="numAssassinos">
  ...
  <experiment name="tesdasfasdf" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="numAssassinos">
  ...
  <experiment name="okuhi" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="numAssassinos">
